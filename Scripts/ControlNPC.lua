--by @im_patrick on youtube, also thanks @im_patrick for the script :D

if patricknpcpanel then return end; patricknpcpanel = true

local load = loadstring(game:HttpGet("https://raw.githubusercontent.com/loldo-g/EstrelaHub/refs/heads/main/Scripts/Modules/NPC%20Control%20Module.lua"))()
		...
		con1 = rs.Stepped:Connect(function()
			...
			for _, part in pairs(nbp) do
				...
				if model and isnpc(model) then
					...
					if hrp and hrp.ReceiveAge == 0 and not hrp.Anchored and npc ~= lp.Character then
